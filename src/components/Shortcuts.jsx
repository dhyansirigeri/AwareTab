...
const StyledWrapper = styled.div`
  ...
  .icon-content { margin: 0 10px; position: relative; }
  .icon-content .tooltip {
    position: absolute; top: -30px; left: 50%; transform: translateX(-50%);
    color: #fff; padding: 6px 10px; border-radius: 15px; opacity: 0; visibility: hidden;
  ...
  .icon-content a {
    ...
    align-items: center; width: 50px; height: 50px; border-radius: 20%; color: #fff;
  ...
  .icon-content a svg { position: relative; z-index: 1; width: 30px; height: 30px; }
  .icon-content a:hover { color: white; box-shadow: 3px 2px 45px 0px rgb(0 0 0 / 50%); }
  .icon-content a .filled {
    position: absolute; top: auto; bottom: 0; left: 0; width: 100%; height: 0;
    background-color: #000; transition: all 0.3s ease-in-out; z-index: 0; border-radius: 20%;
  }
  ...
  .icon-content a[data-social="spotify"] .filled, .icon-content a[data-social="spotify"] ~ .tooltip {
    background: linear-gradient(135deg, #0f3d1f, #146b35, #1db954, #0d2916);
    background-size: 400% 400%; animation: premiumGradient 6s ease infinite; border: 1px solid rgba(29, 185, 84, 0.6);
  }
  .icon-content a[data-social="pinterest"] .filled, .icon-content a[data-social="pinterest"] ~ .tooltip {
    background: linear-gradient(135deg, #3d0a0f, #7a0f1c, #bd081c, #4a0b12);
    background-size: 400% 400%; animation: premiumGradient 6s ease infinite; border: 1px solid rgba(189, 8, 28, 0.6);
  }
  .icon-content a[data-social="dribbble"] .filled, .icon-content a[data-social="dribbble"] ~ .tooltip {
    background: linear-gradient(135deg, #3a0f24, #7a1f4d, #ea4c89, #4a0f2d);
    background-size: 400% 400%; animation: premiumGradient 6s ease infinite; border: 1px solid rgba(234, 76, 137, 0.6);
  }
  .icon-content a[data-social="telegram"] .filled, .icon-content a[data-social="telegram"] ~ .tooltip {
    background: linear-gradient(135deg, #0a1f2d, #0f4a66, #0088cc, #0a2e44);
    background-size: 400% 400%; animation: premiumGradient 6s ease infinite; border: 1px solid rgba(0, 136, 204, 0.6);
  }
